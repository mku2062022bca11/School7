      ...
      <Section background="white">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            Why Choose {content.schoolName.split(" ")[0]}{" "}
            {content.schoolName.split(" ")[1]}?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We provide a unique educational experience that combines academic
            excellence with environmental consciousness and holistic
            development.
          </p>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mt-4 font-semibold">
              - {content.principalName}, Principal
            </p>
          </motion.div>
        </div>
      </Section>
      ...
      <Section background="gray">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Discover what makes {content.schoolName} special
          </p>
        </div>
          ...
          {[
            ...
            >
              <div className="bg-white rounded-full w-24 h-24 md:w-32 md:h-32 flex items-center justify-center mx-auto mb-4 shadow-lg">
                <span className="text-2xl md:text-3xl font-bold theme-text-primary">
                  {stat.number}
                </span>
              </div>
